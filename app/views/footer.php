...
<footer id="footer" class="flex-shrink-0">
   ...
   <div class="d-inline-block text-center">
    ...
    <div class="col-xs-12 col-sm-6 col-md-4 mt-4 text-center">
    
    <div class="widget no-box">
    <h5 class="text-white col-12 text-center">
    Subscribe to our newsletter , so that you can be the first to know about new offers and promotions  </div>
    ...
    <img src="/ElectronicEcommerce/app/assets/images/pay.png"
                    style="width:70px; height:50px;" class="mx-auto mt-4 ">
</div>      
    </div>
