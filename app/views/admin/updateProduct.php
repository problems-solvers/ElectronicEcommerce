    ...
    ?>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 w-50 h-50">
                <input id="pro_imgs" name="pro_imgs[]" value="<?php echo $row->pro_imgs; ?>" multiple class="input-file"
                    type="file">
                <?php
    ...
    ?>
        ...
        <div class="form-group">
            <div class="col-md-4">
                ...
                <button id="singlebutton" name="singlebutton" class="btn btn-primary mybtn">update PRODUCT</button>
            </div>
        </div>
        <?php
}
