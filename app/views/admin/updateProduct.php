    ...
    <fieldset class="form-fieldset">
        ...
        <div class="form-radio form-radio-inline">
            ...
            <div class="form-group">
                ...
                <div class="">
                    <input id="product_name" name="pro_name" value="<?php echo $row->pro_name; ?>"
...
?>
            ...
            <div class="form-group">
                ...
                <div class="">
                    <input id="tag_name" name="tag_name" value='<?php echo $row->tag_name;?>'
                        class="form-control input-md" required="" type="text">
                ...
                <div class="">
                    ...
                    <div class="controls col-12" id="profs">
                        <div id="field" class=" form-inline">
                            <input autocomplete="off" class="input form-control" id="field1" name="field[1]" type="text"
                                value='<?php echo  $row->tag_data;?>' data-items="8" />
   ...
   echo '  <input id="is_active" name="is_active"  type="checkbox"  >IS_ACTIVE';
    ...
    ?> </div>
                ...
                <div class="form-group">
                    ...
                    <div class="">
                        <input id="pro_price" name="pro_price" value="<?php echo $row->pro_price; ?>"
                            class="form-control input-md" required="" type="number">
                ...
                <div class="form-group">
                    ...
                    <div class="">
                        <input id="pro_imgs" name="pro_imgs[]" multiple type="file"
                            value="<?php echo $row->pro_imgs; ?>" multiple class="input-file" type="file">
                            <?php
  ...
  ?>
            ...
            <div class="form-group btn-sm">
                <div class="col-md-4">
                    ...
                    <button class="bt col-12 btn-fulied " action="/ElectronicEcommerce/admin/admin_product/view"
