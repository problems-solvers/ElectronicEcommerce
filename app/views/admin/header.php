                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/admin/admin_advertiment/add_adver"><i class="fas fa-fw fa-table"></i>Customers</a>
                                    </li>
                                    <li class="nav-divider">
                                        Products Management
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/admin/admin_offer"><i class="fas fa-fw fa-map-marker-alt"></i>Offers</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
