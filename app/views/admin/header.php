                        ...
                        <nav class="navbar navbar-expand-lg navbar-light">
                            ...
                            <div class="collapse navbar-collapse" id="navbarNav">
                                <ul class="navbar-nav flex-column">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link active" href="http://localhost/ElectronicEcommerce/admin/admindashboard"><i class="fa fa-fw fa-user-circle"></i>Dashboard<span class="badge badge-success">6</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/admin/adminuielements"><i class="fa fa-fw fa-rocket"></i>UI Elements</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/admin/adminreports"><i class="fas fa-fw fa-chart-pie"></i>Reports</a>
                                    
                                    </li>
                                    <li class="nav-item ">
                                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/admin/adminusers"><i class="fab fa-fw fa-wpforms"></i>Users and Roles</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/admin/admincustomers"><i class="fas fa-fw fa-table"></i>Customers</a>
                                    </li>
                                    <li class="nav-divider">
                                        Products Management
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/admin/admincategories"><i class="fas fa-fw fa-file"></i> Categories and Tags </a>
                                      
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/admin/adminproduct"><i class="fas fa-fw fa-inbox"></i>Products <span class="badge badge-secondary">New</span></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/admin/adminstorinformition"><i class="fas fa-fw fa-columns"></i>Store Info</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/admin/adminorders"><i class="fas fa-fw fa-map-marker-alt"></i>Orders</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/admin/adminoffers"><i class="fas fa-fw fa-map-marker-alt"></i>Offers</a>
                                    </li>
                                </ul>
                            </div>
                        </nav>
