                    ...
                    <!-- start add form-->
                    <form class="form-horizontal"  action="/ecomm/admin/admin_product/add"  method="POST" enctype="multipart/form-data">
<fieldset>
...
<div class="form-group">
  <div class="col-md-4">
    <button id="singlebutton" action="/ecomm/admin/admin_product/view" name="singlebutton" class="btn btn-primary">ADD PRODUCT</button>
  </div>
  </div>
  </form>