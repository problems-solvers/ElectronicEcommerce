...
<head>
    ...
    <title>Electronice Ecommerce</title>
   <style>
   .bor{
     border-radius: 50%;
     z-index:9999;
...
<div class="header" id="myHeader">
    <div class="row "  >
            <div class="col-lg-3 col-md-4 col-sm-12 mx-2">
                <a class="navbar-brand" href="http://localhost/ElectronicEcommerce/"> <img
           ...
           <a class="nav-link mx-2" href="http://localhost/ElectronicEcommerce/cart/">
               ...
               <a  class="nav-link mx-2" href="#"> <img src="'.$_SESSION["user_img"].'" width="25px" height="25px" style="border-radius:100%;">
                                ...
                                <div class="w3-dropdown-content w3-bar-block w3-border men">
                                  ...
                                  <a href="http://localhost/ElectronicEcommerce/userprofiel/" class="w3-bar-item mendev">Account</a>
                                  <a href="http://localhost/ElectronicEcommerce/userprofiel/address" class="w3-bar-item mendev">Address</a>
                                  <a href="http://localhost/ElectronicEcommerce/userprofiel/payment" class="w3-bar-item mendev">Payment</a>
                                  <a href="http://localhost/ElectronicEcommerce/userprofiel/order" class="w3-bar-item mendev">Orders</a>
                                  <a href="http://localhost/ElectronicEcommerce/user/logout" class="w3-bar-item mendev">Logout</a>
                                </div>
                              </div>
                ';
                }
                ...
                <span  style="color:#836691 ;font-size:16px;">
                <div class="w3-dropdown-hover bor">
                <a href="#"> <img src="/ElectronicEcommerce/app/assets/images/img_avatar.png" width="25px" height="25px" style="border-radius:100%;">
                                </a>
                                <div class="w3-dropdown-content w3-bar-block w3-border men">
                                  
                                  <a href="http://localhost/ElectronicEcommerce/user/login" class="w3-bar-item mendev">Login</a>
                                </div>
                              </div>
                    ';
                }
                ...
                <div class="collapse navbar-collapse "  id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <?php
                          ...
                          ?>
                        <li class=" mx-2 nav-item <?php echo $home;?>">

                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/">Home<span
                                class="sr-only">(current)</span></a>
                        </li>
                        
                        <li class="  mx-2 nav-item submenu dropdown <?php echo $categories;?>">
                        ...
                        <li class=" mx-2  nav-item <?php echo $offers;?>">
                        <a class="nav-link" href="#">Offers</a>

                        </li>
                        <li class=" mx-2  nav-item <?php echo $whoare;?>">
                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/home/whoare">About us</a>

                        </li>
                       
                        <li class=" mx-2  nav-item <?php echo $connect;?>">
                        <a class="nav-link" href="http://localhost/ElectronicEcommerce/home/connect">contact us</a>
                        </li>
                   </ul>
                    <ul class="social-footer2 ml-auto text-center">
